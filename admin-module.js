...
export function initCollabUI() {
    ...
    // --- CONTROLE DE ABAS (CORREÇÃO AQUI) ---
    // Esconde abas de Admin e mostra abas de Colaborador
    document.getElementById('tabAdminRequests').classList.add('hidden'); // Garante que a aba do Admin suma
    document.getElementById('adminRequestsView').classList.add('hidden'); // Garante que a view do Admin suma
