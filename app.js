...
setTimeout(hideLoader, 5000); // Trava de segurança
...
function setupAdminUI() {
    ...
    document.getElementById('tabPersonal').classList.remove('hidden'); // Garante que está visível
...
// --- PLANTÃO FINS DE SEMANA (CORRIGIDO PARA ADMIN) ---
